...
python3 multitask_classifier.py --use_gpu --task sts --f baseline_pretrain --lr 1e-3 --option pretrain --batch_size 32 $@
...
python3 multitask_classifier.py --use_gpu --task sts --f baseline_finetune --lr 1e-5 --option finetune --batch_size 32 $@
