...
# python3 multitask_classifier.py --use_gpu --task lin --f lora_1_lin --lr 1e-3 --option finetune --enable_per_layer_finetune --batch_size 16 --lora 1 --epochs 15 $@
...
# python3 multitask_classifier.py --use_gpu --task sts --f lora_2_sts --lr 1e-3 --option finetune --enable_per_layer_finetune --batch_size 32 --lora 2 --epochs 15 $@
python3 multitask_classifier.py --use_gpu --task lin --f lora_2_lin --lr 1e-3 --option finetune --enable_per_layer_finetune --batch_size 16 --lora 2 --epochs 15 $@
...
python3 multitask_classifier.py --use_gpu --task lin --f lora_4_lin --lr 1e-3 --option finetune --enable_per_layer_finetune --batch_size 16 --lora 4 --epochs 20 $@
...
python3 multitask_classifier.py --use_gpu --task lin --f lora_8_lin --lr 1e-3 --option finetune --enable_per_layer_finetune --batch_size 16 --lora 8 --epochs 15 $@
